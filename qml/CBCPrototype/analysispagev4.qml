...
Rectangle {
    ...
    property real markerGuideVerticalOffset: 4.1;
    ...
    Rectangle {
        ...
        anchors.left: controlPanel.left;
        anchors.leftMargin: -parent.width / 100 * 70;
    ...
    Item {
        ...
        anchors.leftMargin: parent.width / 100 * 10;
        anchors.bottom: parent.bottom;
        anchors.bottomMargin: vMargin;
        anchors.right: controlPanel.left;
